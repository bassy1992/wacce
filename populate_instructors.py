...
def populate_instructors():
    ...
    print()
    print("Next steps:")
    print("1. Go to Django admin: /admin/courses/instructor/")
    print("2. Add photos and customize instructor profiles")
    print("3. Test API: curl http://localhost:8000/api/courses/instructors/")
    print()
